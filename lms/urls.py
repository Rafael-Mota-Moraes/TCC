...
urlpatterns = [
    ...
    path("editar-curso/<int:course_id>/",
         views.edit_course, name="edit-course"),
    path("estatisticas-curso/<int:course_id>/",
         views.course_stats, name="course-stats"),
    path("adicionar-aula/<int:course_id>/",
         views.add_lecture, name="add-lecture"),
    path(
    ...
    path("excluir-aula/<int:lecture_id>/",
         views.delete_lecture, name="delete-lecture"),
    path("informacoes-curso/<int:course_id>/",
         views.course_infos, name="course-infos"),
    path(
        "criar-matricula/<int:course_id>/",
        views.register_in_course,
        name="register-in-course",
    ),
    path("course/<int:course_id>/watch/",
